    ...
    stages {
        ...
        stage('Build and Push Docker Image') {
            environment {
                ...
                def project = "shuttle-openshift-heapdump"
            ...
            parallel{
                stage("Deploy: BO"){
                    steps {
                        ...
                        """
                        build job: """../shuttle-openshift-heapdump-deploy/dev""", parameters: [[$class: 'StringParameterValue', name: 'DOCKER_IMAGE_BO', value: """${imagetag}"""],
                ...
                stage("Deploy: CAN"){
                    steps {
                        ...
                        """
                        build job: """../shuttle-openshift-heapdump-deploy/dev""", parameters: [[$class: 'StringParameterValue', name: 'DOCKER_IMAGE_CAN', value: """${imagetag}"""],
